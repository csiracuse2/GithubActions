...
public class Addition
{
    ...
    [TestMethod]
    public void Add_Valid_Siracuse()
    {
    ...
    [TestMethod]
    public void Add_Invalid_Siracuse()
    {
    ...
    [TestMethod]
    public void Subtract_Valid_Siracuse()
    {
    ...
    [TestMethod]
    public void Subtract_Invalid_Siracuse()
    {
    ...
    [TestMethod]
    public void Subtract_Null_Siracuse()
    {
    ...
    [TestMethod]
    public void Multiply_Valid_Siracuse()
    {
    ...
    [TestMethod]
    public void Multiply_Invalid_Siracuse()
    {
    ...
    [TestMethod]
    public void Multiply_Null_Siracuse()
    {
    ...
    [TestMethod]
    public void Divide_Valid_Siracuse()
    {
    ...
    [TestMethod]
    public void Divide_Invalid_Siracuse()
    {
    ...
    [TestMethod]
    public void Divide_Null_Siracuse()
    {
    ...
    [TestMethod]
    public void Power_Valid_Siracuse()
    {
    ...
    [TestMethod]
    public void Power_Invalid_Siracuse()
    {
    ...
    [TestMethod]
    public void Power_Null_Siracuse()
    {
        Assert.ThrowsException<ArgumentNullException>(() => Program.Divide("1", null));
        Assert.ThrowsException<ArgumentNullException>(() => Program.Divide(null, "1"));
        Assert.ThrowsException<ArgumentNullException>(() => Program.Divide(null, null));
